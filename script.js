...
const _HM = [
    ...
    "항아리류 똥겜의 이미지를 생각하며 만든 게임이라 고단한 길이었다면 정상입니다.",
    "",
    "느끼셨겠지만 제목은 많은 고전게임에서 자주 보였던 문구인",
    "'Press any button to Start'를 반대로 비틀어서 만든겁니다.",
    "",
    "맨 처음에는 클리커류 게임을 만들어볼까 했었는데,",
    "좀 더 액티브하게 상호작용을 하는 통통튀는 게임을 만들게 되었네요. :)",
    "",
    "그리고 중력이란 시스템을 넣는데 뭔가 레벨에 따라 중력이 다르도록 설정을 하면서",
    "배경을 우주여행과 달로 해야겠다는 아이디어를 떠올렸습니다.",
    "",
    ...
    "",
    "P.S. 다음에는 진정한 클래식인 플랫포머를 비틀어서 만들어보고 싶네요."
];
...
[_b1, _b2, _b3, _b4].forEach(a => a.loop = true); _b1.volume = 0.1; _b2.volume = 0.3; _b3.volume = 0.3; _b4.volume = 0.40; _sC.volume = 0.5;_sD.volume = 0.5;
...
function _dHE() {
    ...
    if (lastLineY < -_vh(5)) { 
        ...
        _x.fillText('Start to Press Any Button!', _c.width / 2, _vh(90)); 
    }
}
